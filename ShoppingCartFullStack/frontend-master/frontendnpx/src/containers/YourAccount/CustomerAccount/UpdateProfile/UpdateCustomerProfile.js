...
class UpdateCustomerProfile extends Component {
    ...
    constructor(props) {
        ...
        this.updateCustomerProfileClicked = this.updateCustomerProfileClicked.bind(this)
    ...
    updateCustomerProfileClicked = () => {
        const token = localStorage.getItem('token');
        this.props.onUpdateCustomerProfile(this.state.firstName, this.state.lastName, this.state.email,
            this.state.phoneNumber, token);
    }
   uploadImage = async e => {
                ...
                <div className={classes.paper}>
                    ...
                    <form className={classes.form} noValidate>
                        ...
                        <Button
                            ...
                            onClick={this.updateCustomerProfileClicked}
                            type="submit"
                            fullWidth
                            variant="contained"
                        >
...
const mapDispatchToProps = dispatch => {
    return {
        onUpdateCustomerProfile: (firstName, lastName, email, phoneNumber, token) => dispatch(actionCreators.updateCustomerProfile(firstName, lastName, email, phoneNumber, token)),
        onImageUpload: (imageUrl,token) => dispatch(actionCreators.imageUpload(imageUrl,token))

    };
}
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(useStyles)(UpdateCustomerProfile))